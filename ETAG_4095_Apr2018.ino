...
unsigned int wakeUpTime = 329;
unsigned int startTime = 330; //Start time is in minutes. 5*60 + 30 = 330
unsigned int endTime = 690; //End time is in seconds now. 11*60 + 30 = 690
